...
$subject_id = $_GET['id'];
$sql_subject = mysqli_query($link, "SELECT * FROM `disciplina` WHERE `id` = '$subject_id'");
$sql_subject = mysqli_fetch_assoc($sql_subject);
...
<div id="outer-wrap" class="site clr">
    ...
    <div id="wrap" class="clr">
                                ...
                                <div data-elementor-type="wp-page" data-elementor-id="5" class="elementor elementor-5">
                                    <section
                                        ...
                                        <div class="elementor-container elementor-column-gap-wider">
                                            ...
                                            <form action="../../vendor/subjects/update.php" enctype="multipart/form-data" method="post">
                                                <label>
                                                    <input style="display: none" name="user"
                                                           id="user"
                                                           type="text"
                                                ...
                                                <div class="elementor-column elementor-field-type-submit elementor-col-100"
                                                    ...
                                                    <label>
                                                        <input style="margin-bottom: 1%" type="hidden" name="id"
                                                               value="<?= $sql_subject['id'] ?> ">
                                                    </label>
                                                    <label>
                                                        <input id="insert_data_subject_name" name="insert_data_subject_name" style="background-color: white;
        background-position: 10px 10px;
        background-repeat: no-repeat;
        padding: 10px; padding-left: 30px; margin-bottom: 1%" placeholder="Название" type="text"
                                                               value="<?= $sql_subject['name'] ?>">
                                                    </label>
                                                    <label>
        ...
        padding: 10px; padding-left: 30px; margin-bottom: 1%" placeholder="Кол-во часов" type="number"
                                                               value="<?= $sql_subject['hours'] ?>">
                                                    </label>
                                                    <button
                                                        id="sub1"
                                                        class="elementor-size-md elementor-button"
                                                        name="wp-submit" style="width: 60%;">
                                                        <span class="elementor-button-text">Изменить запись</span>
                                                    </button>
                                                </div>
                                            </form>
                                        </div>
